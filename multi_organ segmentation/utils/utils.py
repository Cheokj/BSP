...
# ORGAN_NAME = ['background', 'Liver', 'Kidney', 'Pancreas', 'Spleen', 'Gallbladder']
ORGAN_NAME = ['background', 'Liver', 'Spleen', 'Pancreas', 'Right Kidney', 'Left Kidney', 'Gallbladder']
